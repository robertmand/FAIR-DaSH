...
keypoints:
- FAIR principle adressed (A1) - (Meta)data are retrievable by their identifier using a standardised communications protocol
- FAIR principle adressed (R1.1) - (Meta)data are released with a clear and accessible data usage licence
--- 
### Access to the data
