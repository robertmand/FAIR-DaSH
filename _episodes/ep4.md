...
> ArrayExpress: how to submit your data
> GEO:  NEED an NCBI derived link here (ie a protocol that has been written by NCBI)
> 
{: .callout}
...
communications protocol (A1.1) The protocol is open, free, and universally implementable.

> # Exercise:
> Given the following publication, are you able to find the globally unique and persistent identifier for the RNAseq data and data descriptions (metadata) (F1)?https://doi.org/10.1038/s41591-020-0939-8
> {: .challenge}
...
> # Exercise:
> https://www.ebi.ac.uk/biostudies/ArrayExpress/studies/E-MTAB-8316
amiliarise yourself with the page layout.  Noting there are links to all protocols, data, sample metadata and assay type.
...
Attributes. (R1.3) (Meta)data meet domain-relevant community standards.
...
By using published ontologies following FAIR rpincipals you can ensure metadata are described with appropriately licensed resources.  
